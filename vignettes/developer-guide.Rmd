...
A rule of thumb is that if your document's code execution time exceeds approximately 1 minute, you should consider using local pre-compilation.
...
Then, in your local R environment, run the following code to generate the final Rmd file:
