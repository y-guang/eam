...
对于任何涉及实际计算和运行的 vignettes (文档)，例如涉及模拟的教程，请采用**本地预编译**的方式以加速 github pages 的构建过程。
...
确保在该 Rmd 文件中，将图片路径配置到 `vignettes/` 下的**同名子目录**，并偏好使用矢量图格式（如 SVG）以获得更好的缩放效果。一个示例配置如下：
