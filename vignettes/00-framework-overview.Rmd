...
Traditional single-response tasks are two-alternative forced choice (2AFC) tasks such as lexical decision tasks, and random-dot motion discrimination tasks, while multiple-response tasks are characterized by the production of a sequence of responses within a single trial or episode, as in free recall or verbal fluency tasks. The **eam** package enables modeling responses from both types of tasks.
...
The modular simulation engine is composed of ten modules (see figure below):
...
**Time step**: the discrete increment used to approximate continuous-time evidence accumulation (default at 1\,\emph{ms}).
