...
- Always use fully qualified namespace calls for all non-base functions,
  e.g., use dplyr::filter() instead of filter().
  - Exception: user-facing examples and vignettes (e.g., @examples
    sections) may omit namespaces for readability.
- Adhere strictly to CRAN policies, including documentation
  completeness, namespace hygiene, and other constraints.
